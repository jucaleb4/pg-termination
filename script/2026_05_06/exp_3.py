...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    od["validation_k"] = 30
    env_gamma_alpha_arr = [
        ("gridworld_tiny", 0.9, 1e-5, int(5e6)),
        ("gridworld_tiny", 0.99, 1e-5, int(5e6)),
        ("gridworld_tiny", 0.995, 1e-5, int(5e6)),
        ("gridworld_small", 0.9, 1e-5, int(1e7)),
        ("gridworld_small", 0.99, 1e-5, int(1e7)), 
        ("gridworld_small", 0.995, 1e-5, int(1e7)), 
        ("gridworld_large", 0.9, 1e-5, int(2e7)), 
        ("gridworld_large", 0.99, 1e-5, int(2e7)), 
        ("gridworld_large", 0.995, 1e-5, int(2e7)), 
    ]
