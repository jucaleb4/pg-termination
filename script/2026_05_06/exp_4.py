...
ABOUT = "SARSA full experiment on GridWorld (updated iterations)"
...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    od["validation_k"] = 30
    env_gamma_alpha_arr = [
        ("gridworld_footnote_loop", 0.9, 1e-5, int(5e6)),
        ("gridworld_footnote_loop", 0.99, 1e-5, int(5e6)),
        ("gridworld_footnote_loop", 0.995, 1e-5, int(5e6)),
        ("gridworld_small_loop", 0.9, 1e-5, int(1e7)),
        ("gridworld_small_loop", 0.99, 1e-5, int(1e7)), 
        ("gridworld_small_loop", 0.995, 1e-5, int(1e7)), 
        ("gridworld_large_loop", 0.9, 1e-5, int(2e7)), 
        ("gridworld_large_loop", 0.99, 1e-5, int(2e7)), 
        ("gridworld_large_loop", 0.995, 1e-5, int(2e7)), 
    ]
