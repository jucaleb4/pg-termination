...
ABOUT = "SARSA full experiment on GridWorld-lowdim"
...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    od["validation_k"] = 30
    env_gamma_alpha_arr = [
        ("gridworld_small_low_dim", 0.9, 1e-5, int(1e7)),
        ("gridworld_small_low_dim", 0.99, 1e-5, int(1e7)),
        ("gridworld_small_low_dim", 0.995, 1e-5, int(1e7)),
        ("gridworld_large_low_dim", 0.9, 1e-5, int(2e7)), 
        ("gridworld_large_low_dim", 0.99, 1e-5, int(2e7)), 
        ("gridworld_large_low_dim", 0.995, 1e-5, int(2e7)), 
    ]
