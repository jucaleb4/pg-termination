...
ABOUT = "SPMD full experiment on GridWorld-lowdim"
...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    env_gamma_T_eta_arr = [
        ("gridworld_small_low_dim", 0.9, 10_000, 0.02),
        ("gridworld_small_low_dim", 0.99, 50_000, 0.02),
        ("gridworld_small_low_dim", 0.995, 50_000, 0.005),
        ("gridworld_large_low_dim", 0.9, 50_000, 0.02),
        ("gridworld_large_low_dim", 0.99, 50_000, 0.005),
        ("gridworld_large_low_dim", 0.995, 50_000, 0.005),
    ]
