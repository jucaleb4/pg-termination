...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    env_name_params_arr = [
        ("garnet_50", 0.9, 1e2, 1e0, -0.5),
        ("garnet_50", 0.99, 1e4, 1e2, 1),
        ("garnet_50", 0.995, 1e4, 1e2, 1),
        #
        ("garnet_200", 0.9, 1e0, 1e4, -0.5),
        ("garnet_200", 0.99, 1e4, 1e2, -0.5),
        ("garnet_200", 0.995, 1e4, 1e2, -0.5),
        #
        ("garnet_1000", 0.9, 1e2, 1e0, -0.5),
        ("garnet_1000", 0.99, 1e4, 1e4, 1),
        ("garnet_1000", 0.995, 1e4, 1e4, 1),
    ]
