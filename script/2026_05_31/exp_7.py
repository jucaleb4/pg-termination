...
ABOUT = "Tuned SPMD+CTD on GARNET from enhanced tuning (shortened exp_5.py)"
...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    env_name_params_arr = [
        ("garnet_200", 0.9, "Gaussian", -1, TS, 0.5, 0.5, 1.0, 1),
        ("garnet_200", 0.99, "rff", 100, KL, 0.001, 0.5, 0.562, 1),
        ("garnet_200", 0.995, "Gaussian", -1, TS, 0.5, 0.5, 1.0, 1),
    ]
