...
ABOUT = "Full run SPMD+CTD on GARNET from Refined tuning-v1 (exp_14.py)"
...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    env_name_params_arr = [
        ("garnet_50", 0.9, 1e0, 1e4, -0.5),
        ("garnet_50", 0.99, 1e2, 1e4, -0.5),
        ("garnet_50", 0.995, 1e2, 1e4, -0.5),
        #
        ("garnet_200", 0.9, 1e2, 1e2, -0.5),
        ("garnet_200", 0.99, 1e2, 1e4, -0.5),
        ("garnet_200", 0.995, 1e2, 1e4, -0.5),
    ]
