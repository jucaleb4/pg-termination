...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    env_name_params_arr = [
        ("gridworld_small", 0.9, "Gaussian", 100, KL, 0.5, 0.5, 0.562, 1),
        ("gridworld_small", 0.99, "Gaussian", -1, TS, 0.5, 0.5, 1.0, 1),
        ("gridworld_small", 0.995, "Gaussian", -1, TS, 0.5, 0.5, 1.0, 1),
        ("gridworld_large", 0.9, "Gaussian", -1, TS, 0.5, 0.001, 1.0, 1),
        ("gridworld_large", 0.99, "Gaussian", 100, KL, 0.5, 0.5, 0.562, 1),
        ("gridworld_large", 0.995, "Gaussian", 100, KL, 0.5, 0.5, 0.562, 1),
    ]
    ...
    ct = 0
    for (eta, (env_name, gamma, feat_type, feat_size, update, eta, iota_mult, ukappa, burn_in)) in enumerate(
            env_name_params_arr,
    ):
