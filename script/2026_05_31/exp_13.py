...
ABOUT = "Tuned SPMD+CTD on Grid-World from enhanced tuning (based on exp_4.py)"
...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    env_name_params_arr = [
        ("gridworld_tiny", 0.9,   "rff", 500, KL, 100, 1, 1, -0.5, 1),
        ("gridworld_tiny", 0.99,  "rff", 500, KL, 100, 1, 1, -0.5, 1),
        ("gridworld_tiny", 0.995, "rff", 500, KL, 100, 1, 1, -0.5, 1),
        #
        ("gridworld_small", 0.9, "rff", 500, KL, 100, 10, 100, -0.5, 1),
        ("gridworld_small", 0.99,  "rff", 500, KL, 100, 1, 1, -0.5, 1),
        ("gridworld_small", 0.995, "rff", 500, KL, 100, 1, 1, -0.5, 1),
        #
        ("gridworld_large", 0.9, "rff", 500, KL, 100, 10, 1, -0.5, 0),
        ("gridworld_large", 0.99,  "rff", 500, KL, 100, 10, 100, -0.5, 1),
        ("gridworld_large", 0.995, "rff", 500, KL, 100, 10, 100, -0.5, 1),
    ]
