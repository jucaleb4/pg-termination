...
ABOUT = "Full run SPMD+CTD on GridWorld from Refined tuning-v1 (exp_14.py)"
...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    env_name_params_arr = [
        ("gridworld_tiny", 0.9, 1e4, 1e4, -0.5),
        ("gridworld_tiny", 0.99, 1e0, 1e0, 1),
        ("gridworld_tiny", 0.995, 1e0, 1e0, 1),
        #
        ("gridworld_small", 0.9, 1e0, 1e4, 1),
        ("gridworld_small", 0.99, 1e2, 1e4, -0.5),
        ("gridworld_small", 0.995, 1e2, 1e4, -0.5),
        #
        ("gridworld_large", 0.9, 1e2, 1e2, -0.5),
        ("gridworld_large", 0.99, 1e4, 1e4, -0.5),
        ("gridworld_large", 0.995, 1e4, 1e4, -0.5),
    ]
    ...
    ct = 0
    for (env_name, gamma, eta, iota_mult, uLam_mult) in env_name_params_arr:
