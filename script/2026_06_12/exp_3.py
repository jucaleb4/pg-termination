...
ABOUT = "Full run SPMD+CTD on GARNET from Refined tuning-v2 (exp_18.py)"
...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    env_name_params_arr = [
        ("gridworld_tiny", 0.9, 'Gaussian', 1e0, 2e3, -0.5),
        ("gridworld_tiny", 0.99, 'Gaussian', 1e2, 5e1, -0.5),
        ("gridworld_tiny", 0.995, 'Gaussian', 1e2, 5e1, -0.5),
        #
        ("gridworld_small", 0.9, 'Gaussian', 1e0, 2e3, 1),
        ("gridworld_small", 0.99, 'Gaussian', 1e4, 5e1, -0.5),
        ("gridworld_small", 0.995, 'Gaussian', 1e4, 5e1, -0.5),
        #
        ("gridworld_large", 0.9, 'Gaussian', 1e0, 5e1, -0.5),
        ("gridworld_large", 0.99, 'Gaussian', 1e2, 2e3, -0.5),
        ("gridworld_large", 0.995, 'Gaussian', 1e2, 2e3, -0.5),
    ]
