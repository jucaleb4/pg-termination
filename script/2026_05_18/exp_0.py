...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    ct = 0
    for (env_name, gamma, s_origin, eta, iota, ukappa) in itertools.product(env_name_arr, gamma_arr, s_origin_arr, eta_arr, ctd_iota_arr, ukappa_arr):
