...
ABOUT = "Full run of SPMD+CTD-Dyn on Inventory (not episodic)"
...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    ct = 0
    for (env_name, (gamma, eta, iota_mult, uLam_mult, total_samples)) in itertools.product(env_name_arr, params_arr):
