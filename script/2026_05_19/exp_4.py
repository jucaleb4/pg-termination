...
ABOUT = "SPMD full experiment on GridWorld-loop with Tsallis update"
...
def setup_setting_files(seed_0, n_seeds, n_iters, print_info, skip_save=False):
    ...
    env_gamma_T_eta_maxobs_arr = [
        ("gridworld_footnote_loop", 0.9, 400, 0.5, 5e6),
        ("gridworld_footnote_loop", 0.99, 400, 0.5, 5e6),
        ("gridworld_footnote_loop", 0.995, 2000, 0.02, 5e6),
        ("gridworld_small_loop", 0.9, 400, 0.02, 1e7),
        ("gridworld_small_loop", 0.99, 2000, 0.5, 1e7), 
        ("gridworld_small_loop", 0.995, 400, 0.5, 1e7), 
        ("gridworld_large_loop", 0.9, 400, 0.02, 2e7), 
        ("gridworld_large_loop", 0.99, 400, 0.02, 2e7),
        ("gridworld_large_loop", 0.995, 400, 0.02, 2e7),
    ]
